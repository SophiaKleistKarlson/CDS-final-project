...
# make list of source image names as they are called on my computer
source_names <- c("stim_1", "stim_2", "stim_3", "stim_4", "stim_5", "stim_6", "stim_7", "stim_8", "stim_9", "stim_10", "stim_11", "stim_12")

# make list of drawing names from column 2 in image_names
drawing_names <- image_names[,2]

# bind them together to get one long list of the names of the source and output drawings (for mechanical turk)
